# Generated by Django 5.1.1 on 2024-09-27 06:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Book_image1', models.ImageField(null=True, upload_to='')),
                ('Book_image2', models.ImageField(null=True, upload_to='')),
                ('Book_image3', models.ImageField(null=True, upload_to='')),
                ('Book_image4', models.ImageField(null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.TextField(max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Book_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ChapterChoice_app.book')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ChapterChoice_app.user_reg')),
            ],
        ),
        migrations.CreateModel(
            name='payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_status', models.TextField(choices=[('ORDER_PROCESSED', 'ORDER_PROCESSED'), ('ORDER_DELIVERD', 'ORDER_DELIVERD'), ('ORDER_REJECTED', 'ORDER_REJECTED')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Book_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ChapterChoice_app.book')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ChapterChoice_app.user_reg')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Book_id', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='ChapterChoice_app.book')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ChapterChoice_app.user_reg')),
            ],
        ),
        migrations.CreateModel(
